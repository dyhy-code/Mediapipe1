...
Based on the updated requirement, create the code and ask the user for a comment. • When the user provides feedback about the app, modify the SPEC.MD before making changes to the code.
